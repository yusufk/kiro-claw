...
MEMPALACE_VENV = os.getenv("MEMPALACE_VENV", "")      # optional: host path to a mempalace venv, mounted into the container
MEMPALACE_PALACE = os.getenv("MEMPALACE_PALACE", "")  # optional: host path to FRIDAY's palace dir, mounted into the container
